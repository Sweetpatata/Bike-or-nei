...
def add_bg_from_url():
   st.markdown(
        ...
        <style>
        .stApp {{
            background-image: url("https://storage.googleapis.com/sweet_bucket/pexels-tim-mossholder-1764702.jpg");
...
#'''
original_title = '<p style="font-weight: bold; font-family:Source Sans Pro; color:white; font-size: 42px;">🚲 Oslo City Bike - Maintenance Forecast 🚲</p>'
st.markdown(original_title, unsafe_allow_html=True)
sub_title = '<p style="color:white; font-size: 30px">Predict bicycle station usage</p>'
...
if st.session_state['df'] is not None:
    ...
    details_df['predicted flow: bikes per day'] = details_df['predicted flow: bikes per day'].astype(int)
