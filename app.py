...
sub_title = '<p style="color:Black; font-size: 25px;">Predict bicycle station usage</p>'
...
select_title = '<p style="color:Black; font-size: 30px;">Please choose date</p>'
st.markdown(select_title, unsafe_allow_html=True)
